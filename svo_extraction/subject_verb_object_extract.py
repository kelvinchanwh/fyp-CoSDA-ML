                    ...
                    for obj in objs:
                        ...
                        if is_pas:  # reverse object / subject for passive
                            svos.append((to_str(expand(obj, tokens, visited, removepunctuation)),
                                         "!" + v.lower_ if verbNegated or objNegated else v.lower_, to_str(expand(sub, tokens, visited, removepunctuation))))
                            svos.append((to_str(expand(obj, tokens, visited, removepunctuation)),
                                         "!" + v2.lower_ if verbNegated or objNegated else v2.lower_, to_str(expand(sub, tokens, visited, removepunctuation))))
                        else:
